...
**Challange**: The samples used to construct the dataset varied too much and the output generated by the trained model could sometimes feel incoherent or too noisy.

**Solution**: I used the truncatation trick on the trained StyleGAN to generate better quality sounds (the generated spectrograms already looked good enough before truncation).

### 4. Training the GAN: Trial and Error
